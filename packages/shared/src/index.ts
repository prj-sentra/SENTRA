...
export type TradeStatsDimension = 'symbol' | 'side' | 'exitReason' | 'entryWeekday' | 'session' | 'baseTimeframe' | 'bollingerBandCount' | 'bollingerDirection' | 'executionEvaluation' | 'violationFlags' | 'holdDuration' | 'analysisCompleteness';
