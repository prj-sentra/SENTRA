...
export interface TradeStatsSeriesPoint { key: string; label: string; timestamp: number; count: number; realizedPnl: number; equity: number; oneLotPnl: number; winRate?: number; }
