...
function statefulDb() {
  const state = { lease: undefined as any, cursor: undefined as string | undefined, deals: [] as any[], trade: undefined as any, campaign: undefined as any, membership: undefined as any };
  const db: any = {
