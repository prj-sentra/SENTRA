...
async function main(): Promise<void> {
  ...
  try {
    ...
    await client.query(`DELETE FROM "excursion_work_items" WHERE "trade_id"='verify-trade'; UPDATE "trade_excursion_results" SET "status"='SUCCESS', "failure_reason"=NULL WHERE "trade_id"='verify-trade'`);
